...
| 硷 | 礆 鹼 | 傳統上「礆」是「險」的異體字。1950 年代中國化學界曾試圖區分「鹼、硷」與「碱」，分別對應 Base 與 Alkali，「礆」時與二者混用，後來普遍只用「碱」。1964 年《簡化字總表》規定「鹼」簡化為「硷」，「僉」簡化為「佥」且可類推；2013 年《通用規範漢字表》以「碱」為規範字，「鹼」為異體字，「礆」、「硷」則未錄。 |
